...
import FeaturedContentContainer from './ui/featured-content-container'
import FeaturedContentLeft from './ui/featured-content-left'
import FeaturedContentRight from './ui/featured-content-right'
